...
class FirstViewInteractionControllerDelegate: PSPanGestureInteractionControllerDelegate {
  ...
  @objc func handlePanGestureBeganLeft(#gestureRecognizer: UIPanGestureRecognizer, viewController: UIViewController, interactionController: UIPercentDrivenInteractiveTransition) {
  ...
  @objc func handlePanGestureEndedLeft(#gestureRecognizer: UIPanGestureRecognizer, viewController: UIViewController, interactionController: UIPercentDrivenInteractiveTransition) {
